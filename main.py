...
def update_europe_pop_plot(selected_year):
    ...
    fig = px.pie(filtered_data, names="country", values="pop", title=f"Population of European continent ({selected_year})")
    return fig
...
def update_europe_pop_plot(selected_year):
    ...
    fig = px.line(trajectory, x="lifeExp", y="gdpPercap", color="country", text="year", title=f"Trajectory of Nigeria to Egypt ({selected_year})")
